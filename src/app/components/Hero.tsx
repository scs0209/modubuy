    ...
    <section className="mx-auto mt-8 mx-w-2xl px-4 sm:pb-6 lg:max-w-7xl lg:px-8">
      <div className="mb-8 flex flex-wrap justify-between md:mb-16">
        <motion.div
          ...
          animate="show"
          exit="hidden"
          className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/2 lg:pb-24 lg:pt-48"
        >
        ...
        <motion.div
          ...
          animate="show"
          exit="hidden"
          className="mb-12 flex w-full md:mb-16 lg:w-1/2"
        >
      ...
      <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
        <motion.div
          ...
          animate="show"
          exit="hidden"
          className="flex h-12 w-64 divide-x rounded-lg border"
        >
          {links.map((link) => (
            <div
              key={link.name}
